...
(0, _firebaseJs.auth).onAuthStateChanged(async (user)=>{
    ...
    else window.location.href = "not-logged-in.html";
});
// Elements
...
async function callGeminiAI(message) {
    try {
        const genAI = new (0, _generativeAi.GoogleGenerativeAI)("AIzaSyCKLHTM-Bb9rOnWqLOzBV8GC8_xsHETjpA");
...
},{"./firebase.js":"38sjH","firebase/auth":"79vzg","firebase/firestore":"8A4BC","@google/generative-ai":"gKJrW"}],"gKJrW":[function(require,module,exports,__globalThis) {
/**
